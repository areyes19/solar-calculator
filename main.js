...
var months= document.getElementById(elem).getElementsByTagName('input');
    ...
    for(i=0; i<months.length; i++) {
        ...
        annualUseKw += x;
     }// this to end the loop that was being used
     dailyUseKw = annualUseKw/365;
     return dailyUseKw;

}//end of the function addMonths
...
function calculateSolar(){
    ...
    var feedback="";
    feedback +="<p> Based on your average daily use of "+Math.round(dailyUseKw)+" kWh, you will need to purchase "+panelsNeeded+" "+panelName+" solar panels to offset 100% off your electricity bill.</p>";
...
} // ending the function for calculateSolar()